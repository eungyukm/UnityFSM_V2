...
//     version 1.3.0
//     from Assets/Obliy/Settings/Input/InGameInput.inputactions
//
...
public partial class @InGameInput : IInputActionCollection2, IDisposable
{
    ...
    public struct GameplayActions
    {
        ...
        public GameplayActions(@InGameInput wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @InGameInput m_Wrapper;
        public MenusActions(@InGameInput wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @InGameInput m_Wrapper;
        public DialoguesActions(@InGameInput wrapper) { m_Wrapper = wrapper; }
