...
{
	private static readonly string _path = "Assets/Obliy/Scripts/StateMachine/Editor/Templates";

	[MenuItem("Assets/Create/Obliy State Machines/Action Script", priority = 20)]
	...
	[MenuItem("Assets/Create/Obliy State Machines/Condition Script", priority = 20)]
