...
namespace Obliy.StateMachine.Editor
{
	internal class TransitionTableEditorWindow : EditorWindow
	{
		...
		private static readonly string _uxmlPath = "Assets/Scripts/ObliyStateMachine/Editor/TransitionTableEditorWindow.uxml";
		private static readonly string _ussPath = "Assets/Scripts/ObliyStateMachine/Editor/TransitionTableEditorWindow.uss";
		...
		private void CreateListView()
		{
			...
			Debug.Log("assets name : " + assets[0].name);
